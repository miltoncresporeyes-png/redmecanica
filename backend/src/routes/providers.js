...
router.post('/', auth_js_1.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, _a, type, bio, vehicle, licensePlate, latitude, longitude, address, commune, region, phone, website, paymentMethods, rut, specialties, idDocumentUrl, backgroundCheckUrl, existingUser, existingProfile, newProvider, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 4, , 5]);
                userId = req.user && req.user.id;
                _a = req.body, type = _a.type, bio = _a.bio, vehicle = _a.vehicle, licensePlate = _a.licensePlate, latitude = _a.latitude, longitude = _a.longitude, address = _a.address, commune = _a.commune, region = _a.region, phone = _a.phone, website = _a.website, paymentMethods = _a.paymentMethods, rut = _a.rut, specialties = _a.specialties, idDocumentUrl = _a.idDocumentUrl, backgroundCheckUrl = _a.backgroundCheckUrl;
                if (!userId) {
                    return [2 /*return*/, res.status(401).json({ error: 'No autenticado' })];
                }
                if (!type) {
                    return [2 /*return*/, res.status(400).json({ error: 'Falta campo obligatorio: tipo' })];
                }
            ...
            case 1:
                ...
                if (!existingUser) {
                    return [2 /*return*/, res.status(404).json({ error: 'Usuario no encontrado para crear perfil de prestador' })];
                }
