...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, type, isActive, where, categories, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.query, type = _a.type, isActive = _a.isActive;
                where = {};
                if (type)
                    where.type = type;
...
router.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_js_1.prisma.serviceCategory.findUnique({
...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, category, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                data = shared_1.serviceCategorySchema.parse(req.body);
                return [4 /*yield*/, db_js_1.prisma.serviceCategory.create({
                        data: data,
                    })];
            case 1:
                category = _a.sent();
...
router.patch('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, category, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                data = shared_1.updateServiceCategorySchema.parse(req.body);
                return [4 /*yield*/, db_js_1.prisma.serviceCategory.update({
                        where: { id: req.params.id },
                        data: data,
                    })];
            case 1:
...
router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_js_1.prisma.serviceCategory.delete({
                        where: { id: req.params.id },
                    })];
            case 1:
                _a.sent();
