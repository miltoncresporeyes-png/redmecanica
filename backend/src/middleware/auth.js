...
var auth_js_1 = require("../utils/auth.js"); // Note .js extension for ESM if configured
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!token)
                    return [2 /*return*/, res.status(401).json({ error: 'Acceso denegado: Token no proporcionado' })];
                decoded = (0, auth_js_1.verifyAccessToken)(token);
                if (!decoded)
                    return [2 /*return*/, res.status(403).json({ error: 'Token inválido o expirado' })];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Error verifying user:', error_1);
