...
var AuthRepository = /** @class */ (function () {
    ...
    AuthRepository.prototype.findUserByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, index_js_1.prisma.user.findUnique({
                        where: { email: email },
                        include: {
    ...
    AuthRepository.prototype.createUser = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, name, role, result;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = data.email, password = data.password, name = data.name, role = data.role;
                        if (!(role === 'MECHANIC')) return [3 /*break*/, 2];
                        return [4 /*yield*/, index_js_1.prisma.$transaction(function (tx) { return __awaiter(_this, void 0, void 0, function () {
                                var user;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                    ...
                    case 2: return [2 /*return*/, index_js_1.prisma.user.create({
                            data: {
                                email: email,
                                password: password,
                                name: name,
