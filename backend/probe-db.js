...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, variations_1, connectionString, client, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    connectionString = variations_1[_i];
                    console.log("Testing: ".concat(connectionString));
                ...
                case 5:
                    err_1 = _a.sent();
                    console.log("\u274C FAILED: ".concat(err_1.message));
                    return [3 /*break*/, 6];
                case 6:
                    _i++;
                    return [3 /*break*/, 1];
